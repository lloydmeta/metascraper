...
class ScraperActorSpec
  ...
  describe("integration testing by sending ScrapeUrl messages") {
    ...
    it("should return proper data for a non-redirecting URL") {
      ...
      scrapedData.description should startWith(
        "A collection of findings, snippets and thoughts. My name is Lloyd, a software engineer. In another life, I was a biomedical engineer.")
    ...
    it("should return proper data for a redirecting URL") {
      ...
      scrapedData.description should be(
        "未来のライター【Jii】のテーマソング！ 詳細はこちら→http://jii-lighter.com/ USB充電式電熱線ライター【Jii】はガス不要！風に強い！USB充電で繰り返し使える！安心・安全で環境に優しい！")
      scrapedData.url should be("https://www.youtube.com/watch?v=G8CeP15EAS8")
      scrapedData.mainImageUrl should (be("https://i.ytimg.com/vi/G8CeP15EAS8/hqdefault.jpg") or be(
        "http://i.ytimg.com/vi/G8CeP15EAS8/hqdefault.jpg"))
      scrapedData.imageUrls should (contain("https://i.ytimg.com/vi/G8CeP15EAS8/hqdefault.jpg") or contain(
        "http://i.ytimg.com/vi/G8CeP15EAS8/hqdefault.jpg"))
    }

    it("should return proper data for a 303-redirecting URL") {
      scraperActorRef ! ScrapeUrl(
      ...
      scrapedData.imageUrls shouldBe Stream(
        "https://static01.nyt.com/images/2015/09/23/business/23jpEBOOKS1/23jpEBOOKS1-facebookJumbo.jpg",
        "https://static01.nyt.com/images/2015/09/23/business/23jpEBOOKS1/23jpEBOOKS1-master1050.jpg",
        "https://static01.nyt.com/images/2015/09/23/business/23jpEBOOKS2/23jpEBOOKS2-master675.jpg"
      )
    }
    ...
    it("should return proper mostly Empty data for a URL that does not point to HTML") {
      scraperActorRef ! ScrapeUrl(
        "http://www.beachape.com/downloads/code/scala/schwatcher_example.scala")
      val response = receiveOne(30 seconds).asInstanceOf[Either[Throwable, ScrapedData]]
      response should be('right)
      val Right(scrapedData) = response
      ...
      scrapedData.url should be(
        "https://beachape.com/downloads/code/scala/schwatcher_example.scala")
